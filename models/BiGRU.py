...
class BiGRU:
    """
    Class to Train and test the BiGRU model on Mel spectrogram features
    """
    def __init__(self):
        """
    ...
    def build_model(self):
        """
        Function to build the Bidirectional GRU model
        :return: the BiGRU model
        """
    ...
    def train(self):
        """
        Method to train the Bi-GRU model
